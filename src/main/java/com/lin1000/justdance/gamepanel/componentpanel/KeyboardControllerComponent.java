...
public class KeyboardControllerComponent {

    private static Image iconKeyboardController = null;
    ...
    private double angle = 0.5; // 動畫用角度值（radian）

    static{
        //loadImage
            Toolkit kit=Toolkit.getDefaultToolkit();
            iconKeyboardController =kit.getImage("img/icon-keyboardcontroller.png");
    }

    public KeyboardControllerComponent(int p_off_x, int p_off_y) {
    ...
    public void draw(Graphics g) {
        ...
        int originalWidth = iconKeyboardController.getWidth(null);
        int originalHeight = iconKeyboardController.getHeight(null);
        ...
        int driftX = (int) (driftRadius * Math.sin(angle));
        int driftY = (int) (driftRadius * Math.cos(angle* 1.2)); // y 軸變速有趣一點
        ...
        int x = p_off_x + driftX;
        int y = p_off_y + driftY-10;
        ...
        gc.drawImage(iconKeyboardController, x,y,newWidth,newHeight,  null);
