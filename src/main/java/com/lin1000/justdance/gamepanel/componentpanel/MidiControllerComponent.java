...
public class MidiControllerComponent {
    ...
    private double angle = 1.5; // 動畫用角度值（radian）


    static{
        //loadImage
            Toolkit kit=Toolkit.getDefaultToolkit();
            iconXBoxController=kit.getImage("img/icon-midicontroller.png");
    }

    public MidiControllerComponent(int p_off_x, int p_off_y) {
    ...
    public void draw(Graphics g) {
        ...
        gc.drawString("Midi Player Connected!", p_off_x, p_off_y+140);
